...
export function AuthUI({
  ...
  mode: 'login' | 'signup';
  signInWithOAuth: (provider: 'github' | 'google' | 'azure') => Promise<ActionResponse>;
  ...
  async function handleOAuthClick(provider: 'google' | 'github' | 'azure') {
    setPending(true);
  ...
  return (
    <section className='mt-16 flex w-full flex-col gap-16 rounded-lg bg-black p-10 px-4 text-center'>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <button
          className='flex items-center justify-center gap-2 rounded-md bg-blue-500 py-4 font-medium text-black transition-all hover:bg-blue-400 disabled:bg-neutral-700'
